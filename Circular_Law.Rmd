...
animate(g, width = 2000, height = 2000, fps = 15, nframes = 300, res = 300)
anim_save("normal_points.gif")
```

```{r}
g = plot_density_animated(data, "Real")
animate(g, width = 2000, height = 667, fps = 15, nframes = 300, res = 300)
anim_save("normal_density_real.gif")
```

```{r}
g = plot_density_animated(data, "Imaginary")
animate(g, width = 667, height = 2000, fps = 15, nframes = 300, res = 300)
...
```{r}
g = plot_points_animated(data)
animate(g, width = 2000, height = 2000, fps = 4, nframes = 40, res = 300)
anim_save("uniform_points.gif")
```

```{r}
g = plot_density_animated(data, "Real")
animate(g, width = 2000, height = 667, fps = 4, nframes = 40, res = 300)
anim_save("uniform_density_real.gif")
```

```{r}
g = plot_density_animated(data, "Imaginary")
animate(g, width = 667, height = 2000, fps = 4, nframes = 40, res = 300)
